...
_SA_IIR_COEFFS = [
    ...
    [4532,  -97818, 49762,  121739, 3692,  -80900, 29842,  125987, 3304,  -73518, 21158, 130379],  # noqa
    [3200, -111604, 54330,   38124, 2346,  -96970, 38680,   71450, 1764,  -89934, 31184, 121125],  # noqa
    [2802, -117798, 56960,  -21172, 1858, -105542, 44268,   19380, 1118,  -99312, 37840, 107358],  # noqa
    [2672, -121020, 58550,  -55842, 1658, -110540, 47846,  -18635,  808, -105026, 42230,  91389],  # noqa
    [2592, -123058, 59664,  -76871, 1540, -113966, 50446,  -45291,  626, -109070, 45494,  74459],  # noqa
    [2504, -124494, 60512,  -90354, 1448, -116540, 52484,  -64100,  504, -112182, 48094,  57462],  # noqa
    [2516, -125412, 61090,  -99442, 1428, -118262, 53888,  -77633,  436, -114292, 49900,  41025],  # noqa
    [2432, -126218, 61618, -105830, 1362, -119840, 55208,  -87595,  374, -116264, 51618,  25542],  # noqa
    [2414, -126782, 62004, -110479, 1340, -120978, 56178,  -95093,  336, -117698, 52888,  11229],  # noqa
    [2466, -127172, 62280, -113963, 1360, -121782, 56872, -100854,  316, -118714, 53800,  -1828],  # noqa
    [2412, -127580, 62574, -116638, 1324, -122644, 57626, -105363,  288, -119820, 54800, -13631],  # noqa
    [2336, -127934, 62836, -118734, 1276, -123410, 58306, -108951,  264, -120812, 55706, -24237],  # noqa
    [2438, -128112, 62972, -120408, 1330, -123798, 58652, -111849,  262, -121308, 56162, -33731],  # noqa
    [2382, -128364, 63166, -121763, 1296, -124360, 59156, -114220,  246, -122040, 56838, -42213],  # noqa
    [2384, -128548, 63310, -122877, 1294, -124776, 59534, -116183,  238, -122584, 57342, -49785],  # noqa
  ]
...
_SA_ADC_FREQ_RESP_0 = [
    ...
    1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000,
    1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000,
    1.0000, 1.0000, 1.0001, 1.0006, 1.0015, 1.0028, 1.0041, 1.0053,
    1.0061, 1.0064, 1.0056, 1.0052, 1.0048, 1.0039, 1.0034, 1.0024,
    1.0012, 0.9999, 0.9983, 0.9971, 0.9953, 0.9936, 0.9922, 0.9910,
    0.9894, 0.9877, 0.9866, 0.9860, 0.9863, 0.9862, 0.9868, 0.9867,
    0.9873, 0.9881, 0.9891, 0.9901, 0.9908, 0.9913, 0.9922, 0.9935,
    0.9940, 0.9941, 0.9936, 0.9927, 0.9923, 0.9911, 0.9897, 0.9876,
    0.9853, 0.9826, 0.9801, 0.9776, 0.9753, 0.9731, 0.9707, 0.9685,
    0.9663, 0.9641, 0.9627, 0.9618, 0.9615, 0.9611, 0.9605, 0.9602,
    0.9601, 0.9604, 0.9607, 0.9609, 0.9613, 0.9613, 0.9616, 0.9615,
    0.9606, 0.9602, 0.9593, 0.9586, 0.9570, 0.9554, 0.9536, 0.9518,
    0.9496, 0.9473, 0.9451, 0.9429, 0.9408, 0.9388, 0.9368, 0.9355,
    0.9343, 0.9342, 0.9336, 0.9335, 0.9330, 0.9333, 0.9328, 0.9328,
    0.9328, 0.9325, 0.9317, 0.9304, 0.9296, 0.9283, 0.9266, 0.9245,
    0.9211, 0.9180, 0.9142, 0.9100, 0.9058, 0.9009, 0.8964, 0.8917,
    0.8875, 0.8829, 0.8788, 0.8748, 0.8713, 0.8687, 0.8661, 0.8644,
    0.8626, 0.8618, 0.8617, 0.8625, 0.8631, 0.8650, 0.8663, 0.8678,
    0.8685, 0.8691, 0.8703, 0.8708, 0.8712, 0.8706, 0.8691, 0.8661,
    0.8621, 0.8569, 0.8510, 0.8442, 0.8366, 0.8285, 0.8198, 0.8107,
    0.8015, 0.7916, 0.7824, 0.7732, 0.7659, 0.7581, 0.7519, 0.7460,
    0.7415, 0.7375, 0.7338, 0.7312, 0.7298, 0.7295, 0.7297, 0.7306,
    0.7322, 0.7341, 0.7362, 0.7381, 0.7403, 0.7417, 0.7425, 0.7420,
    0.7406, 0.7378, 0.7338, 0.7283, 0.7219, 0.7138, 0.7049, 0.6945,
    0.6839, 0.6721, 0.6601, 0.6480, 0.6364, 0.6250, 0.6142, 0.6039,
    0.5945, 0.5863, 0.5784, 0.5716, 0.5656, 0.5610, 0.5572, 0.5543,
    0.5519, 0.5503, 0.5498, 0.5500, 0.5505, 0.5509, 0.5517, 0.5521,
    0.5518, 0.5510, 0.5497, 0.5476, 0.5453, 0.5427, 0.5404, 0.5383]

_SA_ADC_FREQ_RESP_20 = [
    1.0000,
    1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000,
    1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000,
    1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000,
    ...
    1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000,
    1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000, 1.0000,
    1.0000, 1.0000, 0.9999, 0.9993, 0.9996, 1.0003, 1.0008, 1.0010,
    1.0004, 1.0007, 1.0006, 1.0003, 0.9999, 0.9993, 0.9984, 0.9978,
    0.9975, 0.9972, 0.9968, 0.9956, 0.9944, 0.9940, 0.9928, 0.9921,
    0.9916, 0.9921, 0.9927, 0.9928, 0.9926, 0.9923, 0.9923, 0.9923,
    0.9922, 0.9923, 0.9931, 0.9947, 0.9954, 0.9968, 0.9978, 0.9982,
    0.9985, 0.9983, 0.9985, 0.9991, 0.9993, 1.0000, 0.9999, 0.9996,
    0.9989, 0.9986, 0.9982, 0.9981, 0.9976, 0.9973, 0.9970, 0.9962,
    0.9957, 0.9950, 0.9944, 0.9940, 0.9940, 0.9939, 0.9940, 0.9937,
    0.9943, 0.9942, 0.9953, 0.9959, 0.9967, 0.9973, 0.9971, 0.9977,
    0.9981, 0.9986, 0.9984, 0.9982, 0.9972, 0.9970, 0.9963, 0.9954,
    0.9944, 0.9933, 0.9926, 0.9917, 0.9900, 0.9888, 0.9876, 0.9876,
    0.9873, 0.9861, 0.9850, 0.9840, 0.9839, 0.9839, 0.9840, 0.9843,
    0.9842, 0.9836, 0.9821, 0.9818, 0.9819, 0.9820, 0.9810, 0.9794,
    0.9776, 0.9760, 0.9741, 0.9720, 0.9698, 0.9674, 0.9654, 0.9621,
    0.9586, 0.9555, 0.9516, 0.9486, 0.9455, 0.9429, 0.9403, 0.9381,
    0.9365, 0.9357, 0.9344, 0.9319, 0.9303, 0.9304, 0.9301, 0.9298,
    0.9280, 0.9271, 0.9272, 0.9264, 0.9259, 0.9254, 0.9247, 0.9247,
    0.9229, 0.9204, 0.9179, 0.9160, 0.9138, 0.9109, 0.9056, 0.9019,
    0.8952, 0.8893, 0.8830, 0.8773, 0.8732, 0.8694, 0.8627, 0.8562,
    0.8468, 0.8389, 0.8318, 0.8258, 0.8225, 0.8173, 0.8135, 0.8088,
    0.8051, 0.8018, 0.7992, 0.7970, 0.7952, 0.7929, 0.7914, 0.7902,
    0.7888, 0.7865, 0.7839, 0.7815, 0.7778, 0.7739, 0.7696, 0.7652,
    0.7595, 0.7526, 0.7453, 0.7387, 0.7310, 0.7228, 0.7139, 0.7054,
    0.6965, 0.6872, 0.6786, 0.6702, 0.6619, 0.6538, 0.6452, 0.6385,
    0.6320, 0.6270, 0.6211, 0.6158, 0.6107, 0.6061, 0.6016, 0.5972,
    0.5929, 0.5895, 0.5863, 0.5832, 0.5814, 0.5794, 0.5780, 0.5765]


class SpectrumAnalyzer(_frame_instrument.FrameBasedInstrument):
    """ Spectrum Analyzer instrument object.

    To run a new Spectrum Analyzer instrument, this should be instantiated
    and deployed via a connected
    :any:`Moku` object using :any:`deploy_instrument`. Alternatively, a
    pre-configured instrument object
    can be obtained by discovering an already running Spectrum Analyzer
    ...
    """
    def __init__(self):
        """ Create a new Spectrum Analyzer instrument, ready to be attached
            to a Moku."""
        super(SpectrumAnalyzer, self).__init__()
        self._register_accessors(_sa_reg_handlers)

        self.scales = {}
        self._set_frame_class(
            SpectrumData, instrument=self, scales=self.scales)
    ...
    def _calculate_decimations(self):
        ...
        # Doesn't guarantee a total decimation of the ideal value,
        # even if such an integer sequence exists
        f1 = self.f1
        f2 = self.f2
    ...
    def _set_decimations(self, d1, d2, d3, d4, ideal):
        ...
        log.debug("Decimations: %d %d %d %d = %d (ideal %f)",
                  d1, d2, d3, d4, total_decimation, ideal)
    ...
    def _calculate_rbw(self):
        ...
        return min(max(rbw, (17.0 / 16.0) * fbin_resolution * window_factor),
                   2**10.0 * fbin_resolution * window_factor)
    ...
    def _set_demodulation_compensation(self):
        """
            This function is called to re-calculate the offsets, dithering
            gains and under saturation sinewave gains used to remove spectral
            artefacts from the instrument.
        """
    ...
    def _compensation_dithering(self):
        self.demod_dither_bitshift = max(
            min(int(self.demod_sinegen_bitshift) - 1, 2), 0)
    ...
    def _update_dependent_regs(self):
        """
            This function is called at commit time to ensure a consistent Moku
            register state.
            It sets all registers that are dependent on other register values
        ...
        self.gain_sos1, self.a1_sos1, self.a2_sos1, self.b1_sos1 = \
            filter_set[4:8]
        self.gain_sos2, self.a1_sos2, self.a2_sos2, self.b1_sos2 = \
            filter_set[8:12]
        ...
        # Output waveform generator sweep depends on the instrument parameters
        # for optimal
        ...
        log.debug("DM: %f FS: %f, BS: %f, RD: %f, W:%d, RBW: %f, RBR: %f",
                  self.demod, fspan, buffer_span, self.render_dds,
                  self.window, rbw, self.rbw_ratio)

    @needs_commit
    def set_span(self, f1, f2):
        """ Sets the frequency span to be analysed.

        Rounding and quantization in the instrument limits the range of spans
        for which a full set of 1024 data points can be calculated. This means
        that the resultant number of data points in
        :any:`SpectrumData` frames will vary with the set span. Note however
        that the associated frequencies are
        ...
        :raises InvalidConfigurationException: if the span is not
            positive-definite.
        """
        _utils.check_parameter_valid(
            'range', f1, [0, 250e6], 'left frequency', 'Hz')
        _utils.check_parameter_valid(
            'range', f2, [0, 250e6], 'right frequency', 'Hz')
        if f2 <= f1:
            raise InvalidConfigurationException(
                "Span must be non-negative with f2 > f1")
    ...
    def set_rbw(self, rbw=None):
        ...
        Actual resolution bandwidth will be rounded to the nearest allowable
        unit when settings are applied to the device.

        :type rbw: float
        :param rbw: Desired resolution bandwidth (Hz), or ``None`` for
         auto-mode
    ...
    def set_window(self, window):
        ...
        window = _utils.str_to_val(
            _str_to_window_function, window, 'window function')
        self.window = window
    ...
    def _calculate_adc_freq_resp(self, f, atten):
        ...
        correction = r[int(math.floor(idx))] + (idx - math.floor(idx)) \
            * (r[int(math.ceil(idx))] - r[int(math.floor(idx))])
        return correction
    ...
    def _calculate_scales(self):
        """
        Returns per-channel correction and scaling parameters required for
        interpretation of incoming bit frames
        Parameters are based on current instrument state
        """
        # Returns the bits-to-volts numbers for each channel in the current
        # state
        ...
        g1 *= _SA_INT_VOLTS_SCALE * filt_gain * window_gain \
            * self.rbw_ratio * (2**10)
        g2 *= _SA_INT_VOLTS_SCALE * filt_gain * window_gain \
            * self.rbw_ratio * (2**10)

        # Find approximate frequency bin values
        dev_start_freq = self._calculate_start_freq()
        dev_freq_step = self._calculate_freq_step()
        freqs = [(dev_start_freq + dev_freq_step * i)
                 for i in range(_SA_SCREEN_WIDTH)]

        # Compute the frequency dependent correction arrays
        # The CIC correction is only for CIC1 which is decimation=4 only,
        # and 10th order
        if self._total_decimation >= 4:
            cic_corrs = [self._calculate_cic_freq_resp(i * dev_freq_step,
                                                       4,
                                                       10)
        ...
        fcorrs = [(1 / self._calculate_adc_freq_resp(f, True) / cic_corr)
                  for f, cic_corr in zip(freqs, cic_corrs)]

        return {'g1': g1,
                'g2': g2,
                'fs': freqs,
                'fcorrs': fcorrs,
                'fspan': [self.f1, self.f2],
                'dbmscale': self.dbmscale}
    ...
    def gen_sinewave(self, ch, amp, freq, sweep=False):
        ...
        :type sweep: bool
        :param sweep: Sweep current frequency span (ignores freq parameter if
        ...
        """
        _utils.check_parameter_valid(
            'set', ch, [1, 2], 'output channel')
        _utils.check_parameter_valid(
            'range', amp, [0.0, 2.0], 'sinewave amplitude', 'Volts')
        _utils.check_parameter_valid(
            'range', freq, [0, 250e6], 'sinewave frequency', 'Hz')
    ...
    def _set_sweep_increments(self):
        """
        Calculates the optimal frequency increment for the generated output
        sinewaves sweep based on FFT computation time and framerate.
        """
        fspan = self.f2 - self.f1
        ...
        log.debug("SW1: %s, AMP1: %f, INCR1: %f, FREQ1: %f/%f, SW2: %s, "
                  "AMP2: %f, INCR2: %f, FREQ2: %f/%f",
                  self.sweep1, self.tr1_amp, self.tr1_incr, self.tr1_start,
                  self.tr1_stop, self.sweep2, self.tr2_amp, self.tr2_incr,
                  self.tr2_start, self.tr2_stop)
    ...
    def _on_reg_sync(self):
        ...
        if self.dec_enable:
            d1 = 4
            total_decimation = d1 * self.dec_cic2 * self.dec_cic3 \
                * self.dec_iir
        else:
            total_decimation = 1
    ...
    def get_data(self, timeout=None, wait=True):
        ...
        On SpectrumAnalyzer this is an alias for :any:`get_realtime_data
        <pymoku.instruments.SpectrumAnalyzer.get_realtime_data>` as the
        output data is never downsampled from the sweep results.
        """
        _utils.check_parameter_valid(
            'float', timeout, desc='data timeout', allow_none=True)
...
_sa_reg_handlers = {
    'demod':
        (REG_SA_DEMOD,
            to_reg_unsigned(0, 32, xform=lambda obj, f: f * _SA_FREQ_SCALE),
    ...
    'tr1_amp':
        (REG_SA_TR1_AMP,
            to_reg_unsigned(0, 16,
                            xform=lambda obj, p: p / obj._dac_gains()[0]),
            from_reg_unsigned(0, 16,
                              xform=lambda obj, p: p * obj._dac_gains()[0])),
    'tr1_start':
        ((REG_SA_TR1_START_H, REG_SA_TR1_START_L),
            to_reg_unsigned(0, 48,
                            xform=lambda obj, p: p * _SA_SG_FREQ_SCALE),
            from_reg_unsigned(0, 48,
                              xform=lambda obj, p: p / _SA_SG_FREQ_SCALE)),
    'tr1_stop':
        ((REG_SA_TR1_STOP_H, REG_SA_TR1_STOP_L),
            to_reg_unsigned(0, 48,
                            xform=lambda obj, p: p * _SA_SG_FREQ_SCALE),
            from_reg_unsigned(0, 48,
                              xform=lambda obj, p: p / _SA_SG_FREQ_SCALE)),
    'tr1_incr':
        ((REG_SA_TR1_INCR_H, REG_SA_TR1_INCR_L),
            to_reg_unsigned(0, 48,
                            xform=lambda obj, p: p * _SA_SG_FREQ_SCALE),
            from_reg_unsigned(0, 48,
                              xform=lambda obj, p: p / _SA_SG_FREQ_SCALE)),
    ...
    'tr2_amp':
        (REG_SA_TR2_AMP,
            to_reg_unsigned(0, 16,
                            xform=lambda obj, p: p / obj._dac_gains()[1]),
            from_reg_unsigned(0, 16,
                              xform=lambda obj, p: p * obj._dac_gains()[1])),
    'tr2_start':
        ((REG_SA_TR2_START_H, REG_SA_TR2_START_L),
            to_reg_unsigned(0, 48,
                            xform=lambda obj, p: p * _SA_SG_FREQ_SCALE),
            from_reg_unsigned(0, 48,
                              xform=lambda obj, p: p / _SA_SG_FREQ_SCALE)),
    'tr2_stop':
        ((REG_SA_TR2_STOP_H, REG_SA_TR2_STOP_L),
            to_reg_unsigned(0, 48,
                            xform=lambda obj, p: p * _SA_SG_FREQ_SCALE),
            from_reg_unsigned(0, 48,
                              xform=lambda obj, p: p / _SA_SG_FREQ_SCALE)),
    'tr2_incr':
        ((REG_SA_TR2_INCR_H, REG_SA_TR2_INCR_L),
            to_reg_unsigned(0, 48,
                            xform=lambda obj, p: p * _SA_SG_FREQ_SCALE),
            from_reg_unsigned(0, 48,
                              xform=lambda obj, p: p / _SA_SG_FREQ_SCALE)),
    ...
    'demod_iq_offset':
        (REG_SA_DEMOD_OFFSET,
            to_reg_unsigned(0, 28),
            from_reg_unsigned(0, 28)),
    'demod_sinegen_freq':
        (REG_SA_DEMOD_SIN_FREQ,
            to_reg_unsigned(0, 32),
            from_reg_unsigned(0, 32)),
    'demod_dither_enable':
        (REG_SA_DEMOD_SHIFT_EN,
            to_reg_bool(0),
            from_reg_bool(0)),
    'demod_sinegen_enable':
        (REG_SA_DEMOD_SHIFT_EN,
            to_reg_bool(1),
            from_reg_bool(1)),
    'demod_dither_bitshift':
        (REG_SA_DEMOD_SHIFT_EN,
            to_reg_unsigned(2, 3),
            from_reg_unsigned(2, 3)),
    'demod_sinegen_bitshift':
        (REG_SA_DEMOD_SHIFT_EN,
            to_reg_unsigned(5, 3),
            from_reg_unsigned(5, 3)),
    'demod_phase_bitshift':
        (REG_SA_DEMOD_SHIFT_EN,
            to_reg_unsigned(8, 5),
            from_reg_unsigned(8, 5))
}
