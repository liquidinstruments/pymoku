...
# generate an amplitude modulated sinewave on Channel 1, and a frequency modulated
...
try:
	...
	# Configure amplitude modulation on channel 1. Frequency modulation on channel 2.
	i.gen_modulate(ch=1, mtype='amplitude', source='internal', depth=1.0, frequency=5e3)
	i.gen_modulate(ch=2, mtype='frequency', source='adc2', depth=500, frequency=50)
